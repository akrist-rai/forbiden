...
const api$2 = window.forbiden;
function TitleBar({ workspace, onOpenFolder }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontFamily: "var(--display)", fontSize: "1rem", letterSpacing: ".14em", marginRight: 12 }, children: [
      "FOR",
      /* @__PURE__ */ jsxRuntimeExports.jsx("em", { style: { color: "var(--red)", fontStyle: "normal" }, children: "BID" }),
      "EN"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, height: 14, background: "var(--border2)", marginRight: 10 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: ".65rem", fontFamily: "var(--mono)", color: "var(--text-dim)", flex: 1 }, children: workspace ? workspace.split("/").slice(-2).join("/") : "No folder open — File → Open Folder" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", WebkitAppRegion: "no-drag" }, children: [
      { label: "─", action: () => api$2.minimize(), color: "#ffd600" },
      { label: "□", action: () => api$2.maximize(), color: "#00e676" },
      { label: "✕", action: () => api$2.close(), color: "#ff1744" }
    ].map(({ label, action, color }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: action,
        style: {
...
function ActivityBar({ sidePanel, setSidePanel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    width: 48,
    flexShrink: 0,
    ...
    BUTTONS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        title: b.title,
        onClick: () => setSidePanel(sidePanel === b.id ? null : b.id),
        style: {
          width: 36,
          height: 36,
          borderRadius: 4,
          ...
          border: "none",
          fontSize: 15,
          color: sidePanel === b.id ? "var(--cyan)" : "var(--text-dim)",
          transition: "all .15s",
          position: "relative"
        },
        children: [
          b.icon,
          sidePanel === b.id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
            position: "absolute",
            left: 0,
            top: "20%",
            bottom: "20%",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Settings", style: {
      width: 36,
      height: 36,
      borderRadius: 4,
      background: "transparent",
...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 5, height: 5, borderRadius: "50%", background: "var(--cyan)", boxShadow: "0 0 6px var(--cyan)" } }),
      panel === "nodes" ? "Graph Nodes" : "Files",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onAdd, style: { background: "transparent", border: "none", color: "var(--cyan)", fontSize: 14, lineHeight: 1 }, title: "Add node", children: "+" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onScan, title: "Scan workspace", style: { background: "transparent", border: "none", color: "var(--text-dim)", fontSize: 12 }, children: scanning ? "⟳" : "↺" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      padding: "6px 12px",
      borderBottom: "1px solid var(--border)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--cyan)" }, children: [
        autoEdges,
        " auto-edges"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        edges.length - autoEdges,
        " manual"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, overflowY: "auto", padding: "4px 0" }, children: nodes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px 16px", textAlign: "center", color: "var(--text-dim)", fontSize: ".7rem", fontFamily: "var(--mono)" }, children: [
      "No nodes yet.",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "Click ↺ to scan workspace."
    ] }) : [...nodes].sort((a, b) => {
      const O2 = { entry: 0, class: 1, module: 2, function: 3, util: 4, test: 5 };
      return (O2[a.type] ?? 9) - (O2[b.type] ?? 9) || a.label.localeCompare(b.label);
    }).map((node) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, flexShrink: 0 }, children: icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".57rem", color: "var(--text-dim)", marginTop: 1, display: "flex", gap: 6 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color }, children: node.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  node.lineCount,
                  "L"
                ] }),
                outEdges > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--cyan)" }, children: [
                  "→",
                  outEdges
                ] }),
                !node.filePath && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--gold)" }, children: "○" })
              ] })
            ] }),
...
function Canvas({
  ...
  const [transform, setTransform] = reactExports.useState({ x: 300, y: 200, scale: 1 });
  const [currentTool, setCurrentTool] = reactExports.useState("select");
  const [connectFrom, setConnectFrom] = reactExports.useState(null);
  const wrapRef = reactExports.useRef(null);
  const isPanning = reactExports.useRef(false);
  const panStart = reactExports.useRef({ mx: 0, my: 0, ox: 0, oy: 0 });
  ...
  reactExports.useEffect(() => {
    ...
    const onWheel = (e) => {
      e.preventDefault();
      const f2 = e.deltaY < 0 ? 1.08 : 0.93;
      const r2 = wrap.getBoundingClientRect();
      const px = e.clientX - r2.left, py = e.clientY - r2.top;
      setTransform((t2) => {
        const ns = Math.min(2.5, Math.max(0.2, t2.scale * f2));
        return { x: px - (px - t2.x) * (ns / t2.scale), y: py - (py - t2.y) * (ns / t2.scale), scale: ns };
      });
    };
  ...
  const handleMouseDown = (e) => {
    if (e.target === wrapRef.current || e.target.id === "canvas-inner") {
  ...
  reactExports.useEffect(() => {
    const onMouseMove = (e) => {
      ...
      if (dragging.current) {
        const { id: id2, mx, my, ox, oy } = dragging.current;
        setTransform((t2) => {
          onMove(id2, ox + (e.clientX - mx) / t2.scale, oy + (e.clientY - my) / t2.scale);
          return t2;
        });
      }
    };
  ...
  const xs = nodes.map((n2) => n2.x), ys = nodes.map((n2) => n2.y);
  const minX = Math.min(...xs) - 80, maxX = Math.max(...xs) + 80;
  const minY = Math.min(...ys) - 80, maxY = Math.max(...ys) + 80;
  const rX = maxX - minX || 1, rY = maxY - minY || 1;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: wrapRef, onMouseDown: handleMouseDown, style: {
    position: "absolute",
    inset: 0,
    overflow: "hidden",
    background: "var(--void)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      ["select", "pan", "connect"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        setCurrentTool(t2);
        setConnectFrom(null);
      }, style: {
        padding: "5px 11px",
        background: currentTool === t2 ? "var(--cyan-dim)" : "transparent",
        border: "none",
        borderRadius: 4,
        fontFamily: "var(--mono)",
        fontSize: ".65rem",
        letterSpacing: ".1em",
        color: currentTool === t2 ? "var(--cyan)" : "var(--text-dim)"
      }, children: t2.toUpperCase() }, t2)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, height: 14, background: "var(--border2)", margin: "0 4px", alignSelf: "center" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTransform({ x: 300, y: 200, scale: 1 }), style: {
        padding: "5px 11px",
        background: "transparent",
        border: "none",
        color: "var(--text-dim)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "canvas-inner", style: {
      position: "absolute",
      inset: 0,
      transformOrigin: "0 0",
      transform: `translate(${transform.x}px, ${transform.y}px) scale(${transform.scale})`
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { style: { position: "absolute", inset: 0, overflow: "visible", pointerEvents: "none", zIndex: 2 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("marker", { id: "arr", markerWidth: "7", markerHeight: "7", refX: "5", refY: "3", orient: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L0,6 L7,3 z", fill: "rgba(0,229,255,0.5)" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("marker", { id: "arr-manual", markerWidth: "7", markerHeight: "7", refX: "5", refY: "3", orient: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L0,6 L7,3 z", fill: "rgba(255,214,0,0.5)" }) })
        ] }),
        edges.map((e) => {
          const src = nodes.find((n2) => n2.id === e.source), tgt = nodes.find((n2) => n2.id === e.target);
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
              ...
              fill: "none",
              stroke: color,
              strokeWidth: e.kind === "manual" ? 2 : 1.5,
              opacity: e.kind === "manual" ? 0.7 : 0.45,
              strokeDasharray: e.kind === "manual" ? "4 4" : "none",
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              border: `1.5px solid ${sel ? color : "var(--border2)"}`,
              borderRadius: 6,
              overflow: "hidden",
              cursor: "pointer",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { height: 64, background: `linear-gradient(135deg, ${color}11, ${color}08)`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.8rem", opacity: 0.5 }, children: icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", bottom: 5, left: 7, fontSize: ".52rem", letterSpacing: ".14em", fontWeight: 700, border: "1px solid", padding: "2px 5px", borderRadius: 2, background: "rgba(6,6,15,.85)", color, borderColor: color }, children: node.type.toUpperCase() }),
                !node.filePath && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 5, right: 7, fontSize: 14, color: "var(--gold)" }, title: "Not linked to file", children: "⚠️" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 2, background: color } }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "7px 9px 9px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".7rem", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: 3 }, children: node.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".58rem", color: "var(--text-dim)", display: "flex", gap: 6 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    node.lineCount,
                    "L"
                  ] }),
                  node.modified && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--gold)" }, children: "● UNSAVED" })
                ] })
              ] })
            ]
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".58rem", letterSpacing: ".14em", color: "var(--text-dim)", marginBottom: 5 }, children: "OVERVIEW" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "110", height: "70", children: nodes.map((n2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "circle",
        {
          cx: 8 + (n2.x - minX) / rX * 94,
          cy: 8 + (n2.y - minY) / rY * 54,
          r: n2.isMain ? 5 : 3,
          fill: COLORS[n2.type] || "#00e5ff",
          opacity: 0.75
        },
        n2.id
      )) })
...
var Ft = de;
const api$1 = window.forbiden;
function CodeEditor({ node, content, onChange, onSave }) {
  if (!node) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-dim)", fontFamily: "var(--mono)", fontSize: ".7rem" }, children: "No node selected" });
  }
  const language = node.label.endsWith(".py") ? "python" : node.label.endsWith(".rs") ? "rust" : node.label.endsWith(".go") ? "go" : node.label.endsWith(".ts") || node.label.endsWith(".tsx") ? "typescript" : "javascript";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: "var(--void)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      height: 36,
      flexShrink: 0,
      padding: "0 12px",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: ".75rem", fontFamily: "var(--mono)", color: "var(--cyan)" }, children: node.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 } }),
      !node.filePath && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => api$1.linkFile(node.id), children: "Link File" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn primary", onClick: () => onSave(content), children: "Save" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, paddingTop: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ft,
      {
        height: "100%",
        language,
...
function Inspector({ node, edges }) {
  if (!node) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-dim)", fontFamily: "var(--mono)", fontSize: ".7rem" }, children: "Select a node to inspect" });
  }
  const incoming = edges.filter((e) => e.target === node.id);
  const outgoing = edges.filter((e) => e.source === node.id);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: "var(--surface)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px 20px", borderBottom: "1px solid var(--border)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".7rem", letterSpacing: ".14em", color: "var(--cyan)", fontWeight: 600, marginBottom: 4 }, children: node.type.toUpperCase() }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.2rem", fontFamily: "var(--display)", letterSpacing: ".05em", color: "var(--text)" }, children: node.label }),
      node.filePath && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".6rem", fontFamily: "var(--mono)", color: "var(--text-dim)", marginTop: 4, wordBreak: "break-all" }, children: node.filePath })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".65rem", letterSpacing: ".12em", color: "var(--text-mid)", marginBottom: 8, fontWeight: 600 }, children: "PROPERTIES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "var(--surface2)", padding: "8px 12px", borderRadius: 4, border: "1px solid var(--border)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".55rem", color: "var(--text-dim)", marginBottom: 2 }, children: "LINES" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".8rem", fontFamily: "var(--mono)", color: "var(--text)" }, children: node.lineCount })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "var(--surface2)", padding: "8px 12px", borderRadius: 4, border: "1px solid var(--border)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".55rem", color: "var(--text-dim)", marginBottom: 2 }, children: "MODIFIED" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".8rem", fontFamily: "var(--mono)", color: node.modified ? "var(--gold)" : "var(--text)" }, children: node.modified ? "Yes" : "No" })
          ] })
        ] })
      ] }),
      node.symbols.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".65rem", letterSpacing: ".12em", color: "var(--text-mid)", marginBottom: 8, fontWeight: 600 }, children: [
          "SYMBOLS (",
          node.symbols.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
          node.symbols.slice(0, 10).map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", padding: "6px 8px", background: "var(--void)", borderRadius: 4, border: "1px solid var(--border2)", fontSize: ".65rem", fontFamily: "var(--mono)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--cyan)" }, children: s.kind }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text)", flex: 1, marginLeft: 10 }, children: s.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--text-dim)" }, children: [
              "L",
              s.line
            ] })
          ] }, i)),
          node.symbols.length > 10 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".6rem", color: "var(--text-dim)", textAlign: "center", marginTop: 4 }, children: [
            "+ ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".65rem", letterSpacing: ".12em", color: "var(--text-mid)", marginBottom: 8, fontWeight: 600 }, children: "CONNECTIONS" }),
        outgoing.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".55rem", color: "var(--text-dim)", marginBottom: 4 }, children: [
            "IMPORTS (",
            outgoing.length,
            ")"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: outgoing.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".6rem", fontFamily: "var(--mono)", padding: "3px 6px", background: "var(--surface2)", borderRadius: 3, border: `1px solid ${e.kind === "manual" ? "var(--gold)" : "var(--border2)"}`, color: "var(--text-mid)" }, children: [
            e.target.substring(0, 8),
            "..."
          ] }, e.id)) })
        ] }),
        incoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".55rem", color: "var(--text-dim)", marginBottom: 4 }, children: [
            "IMPORTED BY (",
            incoming.length,
            ")"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: incoming.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: ".6rem", fontFamily: "var(--mono)", padding: "3px 6px", background: "var(--surface2)", borderRadius: 3, border: `1px solid ${e.kind === "manual" ? "var(--gold)" : "var(--border2)"}`, color: "var(--text-mid)" }, children: [
            e.source.substring(0, 8),
            "..."
          ] }, e.id)) })
        ] }),
        outgoing.length === 0 && incoming.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".65rem", color: "var(--text-dim)", fontStyle: "italic" }, children: "No connections" })
      ] })
    ] })
  ] });
}
function StatusBar({ nodes, edges, workspace, selectedNode, scanning }) {
  const autoEdges = edges.filter((e) => e.kind === "import").length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff", fontWeight: 600 }, children: "FORBIDEN // ENGINE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      nodes.length,
      " NODES"
    ] }),
    ...
    scanning && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--gold)" }, children: "SCANNING WORKSPACE..." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 } }),
    workspace && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      "WS: ",
      workspace.split("/").pop()
    ] }),
    selectedNode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      "SEL: ",
      selectedNode.label
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "NO SELECTION" })
  ] });
}
function Welcome({ onOpenFolder, onScan }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    position: "absolute",
    inset: 0,
    display: "flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: ".85rem", color: "var(--text-mid)", letterSpacing: ".05em", marginBottom: 40 }, children: "Visual Code Intelligence Engine" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.5rem", color: "var(--cyan)" }, children: "📂" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.5rem", color: "var(--red)" }, children: "⚡" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Scan Workspace" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 60, fontSize: ".7rem", color: "var(--text-dim)", fontFamily: "var(--mono)" }, children: "Tip: You can use Cmd/Ctrl + Shift + S to quickly scan the workspace." })
  ] });
}
const api = window.forbiden;
function App() {
  const [graph, setGraph] = reactExports.useState({ nodes: [], edges: [] });
  const [selectedId, setSelectedId] = reactExports.useState(null);
  const [rightTab, setRightTab] = reactExports.useState("code");
  const [sidePanel, setSidePanel] = reactExports.useState("nodes");
  ...
  const selectedNode = graph.nodes.find((n2) => n2.id === selectedId) ?? null;
  reactExports.useEffect(() => {
    api.getState().then((g) => {
      if (g.nodes.length > 0) {
        setGraph(g);
  ...
  reactExports.useEffect(() => {
    const unsubs = [
      api.on("workspace:opened", ({ folder, graph: graph2 }) => {
        setWorkspace(folder);
        setGraph(graph2);
        setShowWelcome(false);
      }),
      api.on("graph:update", (g) => setGraph(g)),
      api.on("menu:scan", () => handleScan()),
      api.on("menu:addNode", () => handleAddNode()),
      api.on("menu:canvas", () => setSidePanel((p2) => p2 === "nodes" ? null : "nodes")),
      api.on("menu:resetLayout", () => {
      })
    ];
    return () => unsubs.forEach((u2) => u2?.());
  }, [workspace]);
  reactExports.useEffect(() => {
    ...
    api.readFile(selectedNode.filePath).then((c) => setFileContent(c ?? ""));
  }, [selectedNode?.filePath]);
  const handleOpenFolder = async () => {
    const res = await api.openFolder();
    if (res?.folder) {
      setWorkspace(res.folder);
      setGraph(res.graph);
      setShowWelcome(false);
    }
  };
  ...
  const handleDeleteNode = async (id2) => {
    const g = await api.deleteNode(id2);
    if (g) {
      setGraph(g);
  ...
  const handleMoveNode = (id2, x2, y2) => {
    api.moveNode(id2, x2, y2);
    setGraph((g) => ({ ...g, nodes: g.nodes.map((n2) => n2.id === id2 ? { ...n2, x: x2, y: y2 } : n2) }));
  };
  ...
  const handleNodeDoubleClick = (id2) => {
    setSelectedId(id2);
    setRightTab("code");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TitleBar, { workspace, onOpenFolder: handleOpenFolder }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityBar, { sidePanel, setSidePanel }),
      sidePanel && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Sidebar,
        {
          panel: sidePanel,
          nodes: graph.nodes,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-center", children: showWelcome ? /* @__PURE__ */ jsxRuntimeExports.jsx(Welcome, { onOpenFolder: handleOpenFolder, onScan: handleScan }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        Canvas,
        {
          nodes: graph.nodes,
          edges: graph.edges,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "right-tabs", children: ["code", "inspector"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: `right-tab${rightTab === t2 ? " active" : ""}`,
            onClick: () => setRightTab(t2),
            children: t2 === "code" ? "⌨ CODE" : "🔍 INSPECTOR"
          },
          t2
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "right-body", children: rightTab === "code" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          CodeEditor,
          {
            node: selectedNode,
            content: fileContent,
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Inspector, { node: selectedNode, edges: graph.edges }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StatusBar,
